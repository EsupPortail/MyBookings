<template>
  <q-card bordered class="my-card">
    <q-card-section>
      <div class="row">
        <div class="col">
          <h1 class="text-h6">{{ $t('workflows.createWorkflow') }}</h1>
        </div>
        <div class="col-auto">
...
import {postWorkFlow} from "../../../../../api/Workflow";
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      postWorkFlow(this.title, autoValidation, autoStart, autoEnd, configuration, this.$router.currentRoute.value.params.id).then(function () {
